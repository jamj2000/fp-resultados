...
<div class="panel-heading alto55">{{ Form::submit('Generar PDF', array('class' => 'btn btn-primary ', 'style' => 'float: right !important;')) }}<b> {{ 'Informes de Evaluación'  }} </b></div>
...
<div class="panel panel-info">
<div class="panel-heading alto55">{{ Form::submit('Generar PDF', array('class' => 'btn btn-primary', 'style' => 'float: right !important;')) }}<b>  {{ 'Informes de Calificaciones'  }} </b></div>
