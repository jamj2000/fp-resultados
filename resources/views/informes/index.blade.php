...
<div class="panel panel-info"><img src="/img/informes.png">
...
<form action="/informes/evaluaciones" method="post" accept-charset="utf-8">
@csrf
...
<div class="panel-heading alto55">
    <input type="submit" value="Generar PDF" class="btn btn-primary" style="float: right !important;"> <b> Informes de Evaluación - Actas </b>
</div>
...
<div class="col-md-6">	
	...
	<div class="checkbox">
	    <label> <input type="checkbox" name="1FPGM A" value="s"  checked >
	      <a href="/informes/evaluacion/1FPGM A/pdf"> <img src="/img/iconos/pdf.png" width=16 ></a>
	      <a href="/informes/evaluacion/1FPGM A/html"> 1FPGM_A </a>	
	    </label><br>
	    <label> <input type="checkbox" name="1FPGM B" value="s"  checked >
	      <a href="/informes/evaluacion/1FPGM B/pdf"> <img src="/img/iconos/pdf.png" width=16 ></a>
	      <a href="/informes/evaluacion/1FPGM B/html"> 1FPGM_B </a>
	    </label><br>	
	    <label> <input type="checkbox" name="2FPGM"   value="s"  checked >
	      <a href="/informes/evaluacion/2FPGM/pdf"> <img src="/img/iconos/pdf.png" width=16 ></a>
	      <a href="/informes/evaluacion/2FPGM/html"> 2FPGM </a>
	    </label><br>	
	    <label> <input type="checkbox" name="1FPGS"   value="s"  checked >
	      <a href="/informes/evaluacion/1FPGS/pdf"> <img src="/img/iconos/pdf.png" width=16 ></a>
	      <a href="/informes/evaluacion/1FPGS/html"> 1FPGS </a>	
	    </label><br>
	    <label> <input type="checkbox" name="2FPGS"   value="s"  checked >
	      <a href="/informes/evaluacion/2FPGS/pdf"> <img src="/img/iconos/pdf.png" width=16 ></a>
	      <a href="/informes/evaluacion/2FPGS/html"> 2FPGS </a>
	    </label><br>
	</div> 
	</div>
...
<form action="/informes/calificacionesvarias" method="post" accept-charset="utf-8">
@csrf
...
<div class="col-md-6">	
	...
	@foreach($alumnos as $alumno)
	    <label> <input type="checkbox" name="{{$alumno->id}}" value="s"  checked > 
	      <a href="/informes/calificaciones/'.$alumno->id) }}"> <img src="/img/iconos/pdf.png" width=16 ></a>
	      <a href="/informes/{{$alumno->id}}"> {{$alumno->apellido1.' '.$alumno->apellido2.', '.$alumno->nombre }} </a>
	    </label><br>	
	@endforeach
	</div> 
	</div>
