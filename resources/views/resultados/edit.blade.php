...
<form action="/resultados/{{$modulo->id}}"  method="post"  accept-charset="utf-8"">
@csrf
...
<div class="panel panel-info">
    ...
    <div class="panel-heading alto55">
     <b>{{ $modulo->curso.' - '.$modulo->nombre }}</b>
     <input type="submit" value="Actualizar" class="btn btn-primary" style="float: right !important;">
    </div>
