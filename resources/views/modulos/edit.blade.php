...
<form action="/modulos/{{$modulo->id}}"  method="post"  accept-charset="utf-8"">
@csrf
...
<div class="row">
	...
	<div class="form-group col-md-4">
        ...
        <input type="text" name="nombre" id="nombre" value="{{ $modulo->nombre }}" class="form-control" disabled>
	</div>

	<div class="form-group col-md-4">
        <label for="ciclo">Ciclo</label>
        <input type="text" name="ciclo" id="ciclo" value="{{ $modulo->ciclo }}" class="form-control" disabled>	
    </div>
</div>
...
<div class="row">
	<div class="form-group col-md-4">
        ...
        <input type="text" name="horas_totales" id="horas_totales" value="{{ $modulo->horas_totales }}" class="form-control  text-right" disabled>
	</div>

	<div class="form-group col-md-4">
        <label for="horas_semanales">Horas semanales</label>
        <input type="text" name="horas_semanales" id="horas_semanales" value="{{ $modulo->horas_semanales }}" class="form-control  text-right" disabled>
	</div>
...
<div class="row">
    ...
    @for ($i = 1; $i <= $modulo->num_resultados; $i++)
        <div class="col-md-1">
            <label for="r{{$i}}_peso">R{{$i}}</label>
			@php $r  = '$modulo->r'.$i.'_peso';  @endphp
            <input type="text" name="r{{$i}}_peso" id="r{{$i}}_peso" value='{{  eval ("return $r;")  }}' class="form-control">
        </div>
	@endfor
    </div>       
    </div> 
