...
<div class="panel panel-info"><img src="/img/alumnos.png" >
  <div class="panel-heading alto55">
    @if (Auth::user()->admin == 's') 
    <a class="btn btn-small btn-primary" style="float: right !important;" href="/alumnos/create">Nuevo</a>
    @endif 
    <b>Alumnos</b>
  </div>
	...
	@foreach($alumnos as $key => $value)
	      ...
	      <a href="alumnos/{{$value->id}}" class="{{$clase}}"> {{ $value->nombre.' '.$value->apellido1.' '.$value->apellido2 }} </a>
	@endforeach
	</div>
</div>
